...
//         var myEvents =[]
//         const url = 'http://pickletour.com/api/get/tournament/page/'
//         axios.get(url+page)
//     .then((response)=>{
...
//                                     return <Text style={{fontFamily:'open-sans-bold',alignSelf:'center',fontSize:Responsive.font(20)}}>Events not found !</Text>
//                                 }
//                             }
//                         }
